...
foreign import java unsafe alias :: String -> Java Column Column
...
-- foreign import java unsafe as2 :: Seq String -> Java Column Column

foreign import java unsafe as2 :: String -> Java Column Column

foreign import java unsafe as3 :: JStringArray -> Java Column Column

foreign import java unsafe as4 :: String -> Metadata -> Java Column Column
...
foreign import java unsafe cast2 :: String -> Java Column Column
...
foreign import java unsafe endsWith2 :: String -> Java Column Column
...
foreign import java unsafe getField :: String -> Java Column Column
...
foreign import java unsafe like :: String -> Java Column Column
...
foreign import java unsafe name :: String -> Java Column Column
...
foreign import java unsafe rlike :: String -> Java Column Column

foreign import java unsafe startsWith :: Column -> Java Column Column

foreign import java unsafe startsWith2 :: String -> Java Column Column
...
foreign import java unsafe toString :: Java Column String
